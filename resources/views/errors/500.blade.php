...
@section('title', 'Server Error · ' . config('app.name', 'Laravel'))
...
<section class="min-h-screen flex flex-col items-center justify-center text-center px-6 py-24">
    <p class="font-display font-extrabold text-brand leading-none" style="font-size: clamp(4.5rem, 12vw, 6.5rem);">500</p>
    <h1 class="font-display font-bold text-xl sm:text-2xl mt-4">Server error</h1>
